    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "zcusclaw node run --host 127.0.0.1 --port 18999",
            "Run the node host in the foreground.",
          ],
          ["zcusclaw node status", "Check node host service status."],
          ["zcusclaw node install", "Install the node host service."],
          ["zcusclaw node start", "Start the installed node host service."],
          ["zcusclaw node restart", "Restart the installed node host service."],

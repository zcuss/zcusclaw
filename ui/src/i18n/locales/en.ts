  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run zcusclaw devices list on the Gateway host.",
        stepApproveId: "Approve this request: zcusclaw devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with zcusclaw status or zcusclaw gateway run.",
        stepUrl:
